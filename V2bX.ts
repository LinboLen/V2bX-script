import { $ } from "dax-sh";
import { install_V2bX, check_status, release } from "./install.js";
...
async function show_menu() {
    ...
    switch (num) {
        ...
        case "3": await uninstall(); break;
        case "4": await start(); break;
        case "5": await stop(); break;
        case "6": await restart(); break;
        case "7": await status(); break;
        case "8": await show_log(); break;
        case "9": await enable(); break;
        case "10": await disable(); break;
        case "11": await install_bbr(); break;
        case "12": await show_V2bX_version(); break;
        case "13": await generate_x25519_key(); break;
        case "14": await generate_config_file(); break;
        case "15": await config(); break;
...
if (argv.length > 2) {
    ...
    const param = argv[3];
    switch (command) {
        case "start": await start(0); break;
        case "stop": await stop(); break;
        case "restart": await restart(); break;
        case "status": await status(); break;
        case "enable": await enable(); break;
        case "disable": await disable(); break;
        case "log": await show_log(); break;
        case "x25519": await generate_x25519_key(); break;
        case "generate": await generate_config_file(); break;
        case "update":
        ...
        case "version": await show_V2bX_version(); break;
        default: await show_menu(); break;
    }
} else {
    await show_menu();
}
